...
public:
	...
	virtual BOOL	Send( unsigned char*, int) {return FALSE;}//used default layer
	virtual BOOL	Send(unsigned char*, int, unsigned char*) { return FALSE; }//used ARP layer
	virtual BOOL	Send(unsigned char*, int, short) { return FALSE; }//used Ethernet layer
	virtual BOOL	Send(unsigned char*, int, unsigned char*, short) { return FALSE; }//used Ethernet layer
	virtual BOOL	Send(unsigned char*) { return FALSE; }	//used IP layer
	
	// param : unsigned char*	- the data of the underlayer
	virtual unsigned char*	Receive(int){ return 0; }//used Chat, File Thread
	virtual unsigned char*	Receive(){ return 0; }//used default layer
	virtual BOOL	Receive(unsigned char*) 	{ return FALSE; }//used DlgLayer
